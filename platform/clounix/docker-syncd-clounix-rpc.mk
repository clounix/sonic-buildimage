...
$(DOCKER_SYNCD_CLOUNIX_RPC)_DEPENDS += $(SYNCD_RPC_DBG) \
                                      $(LIBSWSSCOMMON_DBG) \
                                      $(LIBSAIMETADATA_DBG) \
                                      $(LIBSAIREDIS_DBG)
endif
...
SONIC_STRETCH_DOCKERS += $(DOCKER_SYNCD_CLOUNIX_RPC)
...
$(DOCKER_SYNCD_CLOUNIX_RPC)_BASE_IMAGE_FILES += warm-verifier:/usr/bin/warm-verifier
