...
static struct func_map cpld_update_map[] = {
    {CLX2000_48Y8C_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX2000_SLT_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX4000_24C8D_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX4000_SLT_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    ...
    {CLX25600_H_R1_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX25600_L_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX25600_L_R1_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX25600_L_R2_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {CLX12800_PLATFORM_STRING, anlogic_cpld_update_init, anlogic_cpld_update_exit},
    {ESX25600_64D_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},

    {ARM_CLX4000_24C8D_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
    {ARM_CLX25600_L_PLATFORM_STRING, lattice_cpld_update_init, lattice_cpld_update_exit},
};
