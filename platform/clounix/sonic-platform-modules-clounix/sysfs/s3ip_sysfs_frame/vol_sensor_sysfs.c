...
static struct switch_attribute vol_max_attr = __ATTR(in_max, S_IRUGO | S_IWUSR, vol_sensor_max_show, vol_sensor_max_store);
static struct switch_attribute vol_min_attr = __ATTR(in_min,  S_IRUGO | S_IWUSR, vol_sensor_min_show, vol_sensor_min_store);
