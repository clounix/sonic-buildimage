...
3  红灯常亮(red) 
4  蓝灯常亮(blue) 
5  绿灯闪烁(green light flashing) 
6  黄灯闪烁(yellow light flashing) 
7  红灯闪烁(red light flashing) 
8  蓝灯闪烁(blue light flashing) 
*/
static char *colors[] = {
    "off",
    "blue",
...
#define FAN_LED_STATUS_BIT_MASK (0xF)
#define BMC_LED_STATUS_BIT_MASK (0xF << 4)
#define PSU_LED_STATUS_BIT_MASK (0xF << 8)
...
static unsigned char sysled_state_user_to_dev[] = {DEV_SYSLED_DARK, DEV_SYSLED_GREEN, DEV_SYSLED_YELLOW, DEV_SYSLED_RED,
                                                   DEV_SYSLED_NOT_SUPPORT, DEV_SYSLED_GREEN_BLINKING, DEV_SYSLED_NOT_SUPPORT, DEV_SYSLED_NOT_SUPPORT, DEV_SYSLED_NOT_SUPPORT};
static unsigned char idled_state_user_to_dev[] = {DEV_IDLED_DARK, DEV_IDLED_NOT_SUPPORT, DEV_IDLED_NOT_SUPPORT, DEV_IDLED_NOT_SUPPORT,
                                                  DEV_IDLED_BLUE, DEV_IDLED_NOT_SUPPORT, DEV_IDLED_NOT_SUPPORT, DEV_IDLED_NOT_SUPPORT, DEV_IDLED_BLUE_BLINKING};

static unsigned char led_state_dev_to_user[] = {USER_SYSLED_DARK, USER_SYSLED_GREEN, USER_SYSLED_RED, USER_SYSLED_YELLOW, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT,
                                                USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT};
static unsigned char sysled_state_dev_to_user[] = {USER_SYSLED_DARK, USER_SYSLED_GREEN, USER_SYSLED_RED, USER_SYSLED_YELLOW, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT,
                                                   USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_GREEN_BLINKING, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT};
static unsigned char idled_state_dev_to_user[] = {USER_SYSLED_DARK, USER_SYSLED_BLUE, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT,
                                                  USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_BLUE_BLINKING, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT, USER_SYSLED_NOT_SUPPORT};
...
ssize_t front_panel_show(struct drv_sysled_fpga *sysled, sysled_types_s type, char *buf)
{
    ...
    char *led_type_name[LED_MAX] = {"fan", "psu2", "psu1", "sys", "id"};
...
ssize_t front_panel_store(struct drv_sysled_fpga *sysled, sysled_types_s type, unsigned char state)
{
    ...
    data |= SYSLED_REG_BIT_DATA_WR(type, 0xF, dev_state);
