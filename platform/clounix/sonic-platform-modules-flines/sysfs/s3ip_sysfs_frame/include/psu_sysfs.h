...
struct s3ip_sysfs_psu_drivers_s {
    ...
    ssize_t (*get_psu_out_min_vol)(unsigned int psu_index, char *buf, size_t count);
    ssize_t (*get_psu_out_max_vol)(unsigned int psu_index, char *buf, size_t count);
    ...
    ssize_t (*get_psu_temp_max_hyst)(unsigned int psu_index, unsigned int temp_index, char *buf, size_t count);
    int (*set_psu_temp_max_hyst)(unsigned int psu_index, unsigned int temp_index, const char *buf, size_t count);
