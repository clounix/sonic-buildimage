...
'm24c02',
'lm75',
'pegatron_fn8032_bnf_cpld loglevel=7 requirement_flag=1',
'pegatron_hwmon_mcu loglevel=7',
'pegatron_fn8032_bnf_psu loglevel=7',
'pegatron_fn8032_bnf_sfp loglevel=7',
'i2c-mux-pca9641']
...
SOFT_LINK_NODE_TYPE = ['sensor','transceiver','psu','fan','cpld','syseeprom','sysled','watchdog']
...
SYSEEPROM_TOP_NODE_DICT = [
    #not supported{'src_node':'/sys/module/pegatron_fn8032_bnf_cpld/parameters/loglevel',         'dest_node':SYSEEPROM_PREFIX+'loglevel'},
    #not supported{'src_node':'/sys/module/pegatron_fn8032_bnf_cpld/parameters/',            'dest_node':SYSEEPROM_PREFIX+'debug'},
    #not supported{'src_node':'/sys/module/pegatron_fn8032_bnf_cpld/parameters/',   'dest_node':SYSEEPROM_PREFIX+'bsp_version'},
...
WATCHDOG_TOP_NODE_DICT = [
    ...
    {'src_node':'/sys/bus/platform/devices/iTCO_wdt.1.auto/watchdog/watchdog0/identity',      'dest_node':WATCHDOG_PREFIX+'identity'},
    {'src_node':'/sys/bus/platform/devices/iTCO_wdt.1.auto/watchdog/watchdog0/state',      'dest_node':WATCHDOG_PREFIX+'state'},
    {'src_node':'/sys/bus/platform/devices/iTCO_wdt.1.auto/watchdog/watchdog0/timeleft',      'dest_node':WATCHDOG_PREFIX+'timeleft'},
    {'src_node':'/sys/bus/platform/devices/iTCO_wdt.1.auto/watchdog/watchdog0/timeout',      'dest_node':WATCHDOG_PREFIX+'timeout'},
...
SYSLED_TOP_NODE_DICT = [
    {'src_node':'/sys/module/pegatron_fn8032_bnf_cpld/parameters/loglevel',         'dest_node':SYSLED_PREFIX+'loglevel'},
    ...
    {'src_node':common.I2C_PREFIX+'6-0074/loc_led',      'dest_node':SYSLED_PREFIX+'id_led_status'},
]

TRANSCIEVER_TOP_NODE_DICT = [
    {'src_node':'/sys/module/pegatron_fn8032_bnf_cpld/parameters/loglevel',         'dest_node':TRANSCIEVER_PREFIX+'loglevel'},
...
TRANSCIEVER_PORT_NODE_DICT = [
    {'src_node' : common.I2C_PREFIX+'{}'+'/sfp{}_eeprom',      'dest_node' : TRANSCIEVER_PREFIX+'eth{}/eeprom'},
...
FAN_ATTR_NODE_DICT = [
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/model_name'},
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/serial_number'},
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/vendor'},
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/part_number'},
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/hardware_version'},
    ...
    {'src_node' : common.I2C_PREFIX+'6-0074/fan_led',                           'dest_node' : FAN_PREFIX+'fan{}/led_status'}
]
FAN_MOTOR_NODE_DICT = [
    {'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}_inner_rpm',      'dest_node' : FAN_PREFIX+'fan{}/motor{}/speed'},
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/motor{}/speed_tolerance'},
    #not supported{'src_node' : common.I2C_PREFIX+'4-0070/hwmon/hwmon4/fan{}',      'dest_node' : FAN_PREFIX+'fan{}/motor{}/speed_target'},
...
PSU_ATTR_NODE_DICT = [
    ...
    {'src_node' : common.I2C_PREFIX+'{}/pwr_led',          'dest_node' : PSU_PREFIX+'psu{}/led_status'},
...
PSU_SENSOR_NODE_DICT = [
    ...
    #not supported{'src_node' : common.I2C_PREFIX+'{}/temp{}_type',      'dest_node' : FAN_PREFIX+'psu{}/temp{}/temp_type'},
...
CPLD_TOP_NODE_DICT = [
    {'src_node':'/sys/module/pegatron_fn8032_bnf_cpld/parameters/loglevel',         'dest_node':CPLD_PREFIX+'loglevel'},
...
CPLD_DETAIL_NODE_DICT = [
    ...
    #to be done{'src_node' : common.I2C_PREFIX+'{}'+'/cpld_type',     'dest_node' : CPLD_PREFIX+'cpld{}/type'},
    {'src_node' : common.I2C_PREFIX+'{}'+'/cpld_hw_version',       'dest_node' : CPLD_PREFIX+'cpld{}/hw_version'},
    #to be done{'src_node' : common.I2C_PREFIX+'{}'+'/cpld_board_version',    'dest_node' : CPLD_PREFIX+'cpld{}/board_version'}
]
