...
class SensorUtil(object):
    ...
    def get_sensor_node_info(self, sensor_node, sensor_node_type, sensor_node_name):
    ...
    def get_platform_temp(self, key):
        ...
        regex_int = re.compile(r'\s*(.*)\s+([\d.]+)\s+([\d]+)\s*..\d\d\d\s+([\d]+)\s.*')
        temperature_dict = {}
    ...
    def format_sensor_value(self,value):
        ...
        sensor_p3v3_1_dcdc_voltage = {}
        sensor_p0v79_dcdc_voltage = {}
        # sensor_p12v_main_dcdc_voltage = {}
        for key,values in value.items():
            if key == "P1V8":
                sensor_p1v8_dcdc_voltage["Value"] = int(values[1])/1000
                sensor_p1v8_dcdc_voltage["LowThd"] = "1764"
                sensor_p1v8_dcdc_voltage["HighThd"] = "1836"
                sensor_p1v8_dcdc_voltage["Unit"] = "mV"
                sensor_p1v8_dcdc_voltage["Description"] = "P1V8  Voltage"
                print("%s: Current %s(mA), Voltage %s(mV), Power %s(W)" %(key, values[0], str(int(values[1])/1000), "N/A"))
		continue
                
            if key == "P0V8":
                sensor_p0v8_dcdc_voltage["Value"] = int(values[1])/1000
                sensor_p0v8_dcdc_voltage["LowThd"] = "784"
                sensor_p0v8_dcdc_voltage["HighThd"] = "816"
                sensor_p0v8_dcdc_voltage["Unit"] = "mV"
                sensor_p0v8_dcdc_voltage["Description"] = "P0V8 Voltage"
                       
            if key == "P1V0":
                sensor_p1v0_dcdc_voltage["Value"] = int(values[1])/1000
                sensor_p1v0_dcdc_voltage["LowThd"] = "980"
                sensor_p1v0_dcdc_voltage["HighThd"] = "1020"
                sensor_p1v0_dcdc_voltage["Unit"] = "mV"
                sensor_p1v0_dcdc_voltage["Description"] = "P1V0 Voltage"
            
            if key == "P3V3_0":
                sensor_p3v3_sfp_dcdc_voltage["Value"] = int(values[1])/1000
                sensor_p3v3_sfp_dcdc_voltage["LowThd"] = "3135"
                sensor_p3v3_sfp_dcdc_voltage["HighThd"] = "3465"
                sensor_p3v3_sfp_dcdc_voltage["Unit"] = "mV"
                sensor_p3v3_sfp_dcdc_voltage["Description"] = "P3V3_0 Voltage"
                
            if key == "P3V3_1":
                sensor_p3v3_1_dcdc_voltage["Value"] = int(values[1])/1000
                sensor_p3v3_1_dcdc_voltage["LowThd"] = "3135"
                sensor_p3v3_1_dcdc_voltage["HighThd"] = "3465"
                sensor_p3v3_1_dcdc_voltage["Unit"] = "mV"
                sensor_p3v3_1_dcdc_voltage["Description"] = "P3V3_1 Voltage"

            if key == "P0V79":
                sensor_p0v79_dcdc_voltage["Value"] = int(values[1])/1000
                sensor_p0v79_dcdc_voltage["LowThd"] = "774"
                sensor_p0v79_dcdc_voltage["HighThd"] = "806"
                sensor_p0v79_dcdc_voltage["Unit"] = "mV"
                sensor_p0v79_dcdc_voltage["Description"] = "P0V79 Voltage"
        ...
        sensor_dcdc["P1V8"] = sensor_p1v8_dcdc_voltage
        sensor_dcdc["P0V8"] = sensor_p0v8_dcdc_voltage
        sensor_dcdc["P1V0"] = sensor_p1v0_dcdc_voltage
        sensor_dcdc["P3V3_0"] = sensor_p3v3_sfp_dcdc_voltage
        sensor_dcdc["P3V3_1"] = sensor_p3v3_1_dcdc_voltage
        sensor_dcdc["P0V79"] = sensor_p0v79_dcdc_voltage
    ...
    def get_all(self):
        ...
        cmd = 'cat /sys/s3ip/temp_sensor/temp3/temp_input'
        status,output = run_command(cmd)
        print("FAN_0x48 output: {}".format(output))
        cmd = 'cat /sys/s3ip/temp_sensor/temp4/temp_input'
        status,output = run_command(cmd)
