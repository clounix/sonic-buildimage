...
/************************************psu dir and attrs*******************************************/
static struct switch_attribute psu_number_attr = __ATTR(num, S_IRUGO, psu_number_show, NULL);
...
static struct switch_attribute psu_present_attr = __ATTR(status, S_IRUGO, psu_present_status_show, NULL);
...
static struct switch_attribute psu_fan_ratio_attr = __ATTR(ratio, S_IRUGO | S_IWUSR, psu_fan_ratio_show, psu_fan_ratio_store);
