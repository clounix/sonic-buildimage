...
def fruidutil(args):
    ...
    if args.option in ['get', 'set']:
        cmd += 'fruidutil get' if args.option == 'get' else 'fruidutil set'
        if args.node:
            if 'fan' in args.node:
                cmd = 'fruidutil get fanboard' 
            elif 'psu1' in args.node:
                cmd = 'fruidutil get psu 1'
            elif 'psu2' in args.node:
                cmd = 'fruidutil get psu 2' 
