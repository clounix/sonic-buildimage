...
MASTER_ORIG_FW_CFG = "fpga_master_firmware_baseline.json"
SLAVE_ORIG_FW_CFG = "fpga_slave_firmware_baseline.json"


class FPGAFIRMWAREPROGRAMTC(TestCaseCommon):
    ...
    def __init__(self, index, logger, platform_cfg_file, case_cfg_file=None):
        ...
        MODULE_NAME = "fpga_firmware_program_tc"
