...
class Psu(PsuBase):
    ...
    def __init__(self, index):
        ...
        self.__psu_presence_attr    = "/sys/bus/i2c/devices/6-0074/psu_{}_present".format(self.__index)
        self.__psu_status_attr    = "/sys/bus/i2c/devices/6-0074/psu_{}_status".format(self.__index)
        self.__psu_power_out_attr   = "/sys/bus/i2c/devices/{}/power_out".format(self.psu_bus[self.__index-1])
        self.__psu_voltage_out_attr = "/sys/bus/i2c/devices/{}/vol_out".format(self.psu_bus[self.__index-1])
        self.__psu_current_out_attr = "/sys/bus/i2c/devices/{}/curr_out".format(self.psu_bus[self.__index-1])
