...
#include "drv_wdt_cpld_clx.h"
#include "clx_driver.h"

//external function declaration
extern void __iomem *clounix_fpga_base;
//internal function declaration
static struct drv_wdt_clx drv_wdt;
...
static ssize_t drv_get_watchdog_identify(void *driver, char *buf, size_t count)
{
    ...
    index = scnprintf(buf, PAGE_SIZE, "clounix_cpld_wdt\n");
    return index;
}
...
int drv_watchdog_cpld_init(void **watchdog_driver)
{
