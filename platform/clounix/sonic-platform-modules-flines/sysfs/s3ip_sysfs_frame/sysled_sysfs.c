...
static struct switch_attribute psu2_led_attr = __ATTR(psu2_led_status, S_IRUGO | S_IWUSR, bmc_led_status_show, bmc_led_status_store);
...
static struct switch_attribute psu1_led_attr = __ATTR(psu1_led_status, S_IRUGO | S_IWUSR, sys_psu_led_status_show, sys_psu_led_status_store);
