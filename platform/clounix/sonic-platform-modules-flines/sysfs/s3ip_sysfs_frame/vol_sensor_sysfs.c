...
static struct switch_attribute vol_value_attr = __ATTR(in_input, S_IRUGO, vol_sensor_value_show, NULL);
static struct switch_attribute vol_alias_attr = __ATTR(in_alias, S_IRUGO, vol_sensor_alias_show, NULL);
static struct switch_attribute vol_type_attr = __ATTR(in_type, S_IRUGO, vol_sensor_type_show, NULL);
static struct switch_attribute vol_max_attr = __ATTR(in_max, S_IRUGO, vol_sensor_max_show, NULL);
static struct switch_attribute vol_min_attr = __ATTR(in_min,  S_IRUGO, vol_sensor_min_show, NULL);
static struct switch_attribute vol_crit_attr = __ATTR(in_crit,  S_IRUGO, vol_sensor_crit_show, NULL);
...
static int vol_sensor_sub_single_create_kobj_and_attrs(struct kobject *parent, unsigned int index)
{
    ...
    snprintf(name, sizeof(name), "in%u", index);
