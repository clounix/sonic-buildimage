...
struct s3ip_sysfs_temp_sensor_drivers_s {
    ...
    ssize_t (*get_main_board_temp_max_hyst)(unsigned int temp_index, char *buf, size_t count);
    int (*set_main_board_temp_max_hyst)(unsigned int temp_index, const char *buf, size_t count);
