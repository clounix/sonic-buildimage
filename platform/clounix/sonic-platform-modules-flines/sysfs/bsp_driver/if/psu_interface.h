...
struct psu_fn_if {
    ...
    ssize_t (*get_psu_out_min_vol)(void *driver, unsigned int psu_index, char *buf, size_t count);
    ssize_t (*get_psu_out_max_vol)(void *driver, unsigned int psu_index, char *buf, size_t count);
