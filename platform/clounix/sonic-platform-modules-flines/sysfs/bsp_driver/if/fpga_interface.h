...
struct fpga_fn_if
{
    ...
    ssize_t (*get_main_board_fpga_power_history_reg)(void *driver, unsigned int fpga_index, char *buf, size_t count);
    ssize_t (*get_main_board_fpga_power_history_ctrl)(void *driver, unsigned int fpga_index, char *buf, size_t count);
    int (*set_main_board_fpga_power_history_ctrl)(void *driver, unsigned int fpga_index, unsigned int value);
