...
char g_platform[MAX_PLATFORM_NAME_LEN] = "x86_64-clounix_clx8000_48c8d-r1";
...
static void parse_fpga_sysfs()
{
    ...
    if((0 == strcmp(g_platform,CLX8000_PLATFORM_STRING))
       ...
       ||(0 == strcmp(g_platform,CLX25600_H_R1_PLATFORM_STRING))
       ...
       ||(0 == strcmp(g_platform,CLX25600_L_R1_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,CLX25600_L_R2_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,CLX25600_L_SLT_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,ESX25600_64D_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,CLX4000_24C8D_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,CLX4000_SLT_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,CLX2000_48Y8C_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,CLX2000_SLT_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,DS410G_48Y8C_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,ARM_CLX4000_24C8D_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,ARM_CLX25600_L_PLATFORM_STRING))
       ||(0 == strcmp(g_platform,ARM_DS410H_48Y8C_PLATFORM_STRING))
       )
