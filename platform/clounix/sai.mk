...
VENDOR_PATCH_VERSION=240815
VENDOR_REL_TYPE=CU
# Place here URL where SAI deb exist
# libsaiclx_1.12.0.1-240815.CU_amd64.deb
#
ifeq ($(SAI_DEB_URL),no)
...
SAI_VENDOR_VERSION = $(SAI_HEADER_VERSION).$(VENDOR_VERSION)
CLOUNIX_SAI = libsaiclx_$(SAI_VENDOR_VERSION)_$(PLATFORM_ARCH).deb
$(CLOUNIX_SAI)_URL = "libsaiclx_$(SAI_VENDOR_VERSION)_$(PLATFORM_ARCH).deb"

CLOUNIX_SAI_DEV = libsaiclx-dev_$(SAI_VENDOR_VERSION)_$(PLATFORM_ARCH).deb
$(CLOUNIX_SAI_DEV)_URL = "libsaiclx-dev_$(SAI_VENDOR_VERSION)_$(PLATFORM_ARCH).deb"

CLOUNIX_SAI_DBG = libsaiclx-dbg_$(SAI_VENDOR_VERSION)_$(PLATFORM_ARCH).deb
$(CLOUNIX_SAI_DBG)_URL = "libsaiclx-dbg_$(SAI_VENDOR_VERSION)_$(PLATFORM_ARCH).deb"
