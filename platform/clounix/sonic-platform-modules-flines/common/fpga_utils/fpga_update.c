...
static struct func_map fpga_update_map[] = {
    {CLX2000_48Y8C_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
    {CLX2000_SLT_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
    {CLX4000_24C8D_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
    {CLX4000_SLT_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
    ...
    {CLX25600_H_R1_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
    ...
    {CLX25600_L_R1_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
    {CLX25600_L_R2_PLATFORM_STRING, xilinx_fpga_update_init, xilinx_fpga_update_exit},
